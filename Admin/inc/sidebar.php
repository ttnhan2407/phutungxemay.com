                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <!-- Thong ke -->
                            <a class="nav-link" href="bangthongke.php">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="them_slider.php">Add Sliders</a>
                                    <a class="nav-link" href="lietke_slider.php">List Sliders</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayout2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="them_sanpham.php">Add Product</a>
                                    <a class="nav-link" href="lietke_sanpham.php">List Product</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayout4" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="themtintuc.php">Add News</a>
                                    <a class="nav-link" href="lietketintuc.php">List News</a>
                                </nav>
                            </div>
